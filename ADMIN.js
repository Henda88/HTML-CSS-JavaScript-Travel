...
var tabFlight = [{ id:generateUid(), destination: "", departure: "", return: "", airlines: "", price: "", way: "" }];
...
function AfficherListeFlights() {
    ...
    for (i = 0; i < z.length; i++) {
       tabString = tabString  + `<tr>
        ...
        <td>`+ z[i].price + `</td>
        <td>`+ z[i].way + `</td>
        <td><button id="supp" type="button" onclick="deleteRow(this)">Delete</button></td>
         </tr>`;
    }
...
var tabHotel = [{ id:generateUid(), destination: "", hotel: "", stars: "", room: "", guest: "", price: "" }];
...
var tabCar = [{ id:generateUid(), car: "", pickup: "", dropoff: "", duration: "", price: "" }];
